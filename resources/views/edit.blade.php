    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/brags/{{ $brag->id }}" novalidate>
                        {{ method_field('PATCH') }}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea rows="3" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" id="description" name="description">{{ old('description', $brag->description) }}</textarea>
